        ...
        <>
            ...
            <div className="h-full bg-gray-200 flex flex-col gap-1">
                <div className="relative p-2 bg-white">
                    <b onClick={handleBackToHome} className="hover:text-green-500 transition-all duration-300 cursor-pointer flex items-center gap-1"><FaArrowLeft /> Signing In</b>
                    <span className="content-[''] absolute left-0 bottom-0 bg-[rgba(0,100,0,255)] w-full h-[3px]"></span>
                </div>

                <span className="p-3 my-1 bg-white text-sm text-gray-800">Don`t have an account yet? <span onClick={handleRegister} className='hover:text-green-500 transition-all duration-300 cursor-pointer select-none'>Click here to register.</span></span>
