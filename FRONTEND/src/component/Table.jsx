  ...
  return (
    <div className="max-w-full overflow-x-auto">
      <table className="w-full border-collapse" role="table">
        <thead>
          <tr>
            ...
            {tableHeadings.map((el, index) => {
              return (
                <th
                  className={`max-[1023px]:hidden text-white capitalize p-5 whitespace-nowrap bg-[rgb(138,183,45)] ${
        ...
        <tbody className="max-[1023px]:flex max-[1023px]:flex-col max-[1023px]:gap-3 lg:[&>*:nth-of-type(odd)]:bg-gray-300 lg:[&>*:nth-of-type(even)]:bg-gray-200">
          {data.map((el, index) => {
            return (
              <>
                <tr
                ...
                <div
                  key={index}
                  className="lg:hidden w-full rounded-md flex flex-col"
                >
